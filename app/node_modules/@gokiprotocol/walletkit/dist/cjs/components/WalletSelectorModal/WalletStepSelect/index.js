...
const getWalletProviders = (debugMode = false) => {
    const base = Object.entries(use_solana_1.DEFAULT_WALLET_PROVIDERS)
        ...
        type: walletType,
        info,
        mustInstall: walletType === use_solana_1.DefaultWalletType.ReadOnly
            ? !debugMode
        ...
        .filter((p) => debugMode
        ? true
        : p.type !== use_solana_1.DefaultWalletType.SecretKey &&
            p.type !== use_solana_1.DefaultWalletType.ReadOnly);
    return [
        ...base,
        {
            type: use_solana_1.DefaultWalletType.Ledger,
            info: {
                ...use_solana_1.DEFAULT_WALLET_PROVIDERS.Ledger,
...
const WalletStepSelect = ({ onSelect, onInstall, debugMode, }) => {
    const [showUninstalled, setShowUninstalled] = (0, react_1.useState)(false);
    const [providerInfo, setProviderInfo] = (0, react_1.useState)(getWalletProviders(debugMode));
    (0, react_1.useEffect)(() => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Heading, { children: "Select your wallet" }), (0, jsx_runtime_1.jsxs)(ScrollArea, { children: [(0, jsx_runtime_1.jsx)(Wallets, { children: providerInfo
                            .filter((prov) => showUninstalled
                            ? true
                            : prov.mustInstall || !prov.info.isInstalled)
                            .map((fullInfo) => {
                            const { info: provider, type } = fullInfo;
                            return ((0, jsx_runtime_1.jsx)(WalletProviderOption_1.WalletProviderOption, { type: type, info: provider, onSelect: () => {
                                    onSelect === null || onSelect === void 0 ? void 0 : onSelect(fullInfo);
                                }, onInstall: onInstall }, provider.url));
                        }) }), (0, jsx_runtime_1.jsx)(ShowUninstalledWrapper, { children: (0, jsx_runtime_1.jsxs)(ShowUninstalled, { onClick: () => setShowUninstalled(!showUninstalled), children: [showUninstalled ? "Hide" : "Show", " uninstalled wallets"] }) })] })] }));
};
